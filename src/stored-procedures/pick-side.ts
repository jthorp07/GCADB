...
async function pickSide(con: ConnectionPool, queueId: number, trans?: Transaction) {

    if (!con.connected) return new NotConnectedError("PickSide") as BaseDBError;
    if (!queueId) return new NullArgError(["QueueId"], "PickSide") as BaseDBError;
    ...
    switch (result.returnValue) {
        ...
        case 1:
            return new NullArgError(["QueueId"], "PickSide") as BaseDBError;
    }
